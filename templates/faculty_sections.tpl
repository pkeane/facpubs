...
<h1>Manage your sections</h1>  
    <div class="page-top">
    <ul id="sec_instruct">     
        <li>Optionally use sections to group your citations.  Any initial sections are from your CV.</li>
        <li>Click a section name to edit. Click and drag a section bar to sort. Empty sections may be deleted.</li>
        <li>The "uncategorized" section holds all ungrouped citations. It disappears when empty and cannot be edited.</li>
   </ul>   
